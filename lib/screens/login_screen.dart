      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              SvgPicture.asset(AntologyImages.antLogo, width: 100, height: 100),
              ...
              SizedBox(width: double.infinity, child: ElevatedButton(onPressed: _login, style: ElevatedButton.styleFrom(backgroundColor: Colors.green, padding: const EdgeInsets.all(16)), child: const Text('Login', style: TextStyle(fontSize: 16)))),
